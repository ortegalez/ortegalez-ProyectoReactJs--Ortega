...
const subGreeting = "Sitio en construcción"
  ...
  return (
    <BrowserRouter>
      <NavBar/>
      <Routes>
        <Route  path='/' element={ <ItemListContainer greeting={ greeting } subGreeting={subGreeting}/> }/>
        <Route  path='/categoria/:idCategoria' element={ <ItemListContainer greeting={ greeting } subGreeting={subGreeting}/> }/>
